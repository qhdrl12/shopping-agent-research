...
class LocalPromptManagerSeparated:
    """
    ...
    def get_prompt_list(self, prompt_type: Literal["query_analysis", "model_response"]) -> List[str]:
    ...
    def get_prompt(self, name: str, prompt_type: Literal["query_analysis", "model_response"]) -> Optional[Dict]:
    ...
    def create_prompt(self, name: str, content: str, prompt_type: Literal["query_analysis", "model_response"]) -> Optional[Dict]:
        """새 프롬프트를 생성합니다."""
        try:
            prompts_data = self._load_prompts()
    ...
    def update_prompt(self, prompt_id: int, name: str, content: str, prompt_type: Literal["query_analysis", "model_response"]) -> Optional[Dict]:
        """기존 프롬프트를 수정합니다."""
        try:
            prompts_data = self._load_prompts()
    ...
    def delete_prompt(self, name: str, prompt_type: Literal["query_analysis", "model_response"]) -> bool:
...
if __name__ == '__main__':
    # 예제 사용법
    manager = LocalPromptManagerSeparated()
